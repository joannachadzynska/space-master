...
import { LabsService } from 'projects/space-api/services';
import { Lab, EquipmentTypes } from 'projects/space-api/types';
...
export class LabFormComponent implements OnInit {
    form!: FormGroup;
    step: Observable<keyof Lab> = this.route.queryParams.pipe(
    ...
    ngOnInit(): void {
        this.route.data.subscribe(
            (data) => (this.form = this.formService.buildForm(data['lab']))
        );
    }
